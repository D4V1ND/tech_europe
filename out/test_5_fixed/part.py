...
add1 = cq.Workplane('XZ').workplane(offset=-0.0).moveTo(0.0, 7.0).threePointArc((2.05, 2.05), (7.0, 0.0)).lineTo(28.0, 0.0).threePointArc((32.95, 2.05), (35.0, 7.0)).lineTo(35.0, 100.0).lineTo(0.0, 100.0).close().extrude(-3.0)
result = add1 if result is None else result.union(add1)
add2 = cq.Workplane('XZ').workplane(offset=-0.0).moveTo(81.0, 7.0).threePointArc((83.05, 2.05), (88.0, 0.0)).lineTo(109.0, 0.0).threePointArc((113.95, 2.05), (116.0, 7.0)).lineTo(116.0, 100.0).lineTo(81.0, 100.0).close().extrude(-3.0)
...
add4 = cq.Workplane('YZ').workplane(offset=0.0).moveTo(0.0, 0.0).lineTo(0.0, 100.0).lineTo(105.0, 100.0).lineTo(58.0, 25.0).threePointArc((42.0, 8.0), (30.0, 0.0)).close().extrude(3.0)
result = add4 if result is None else result.union(add4)
add5 = cq.Workplane('YZ').workplane(offset=113.0).moveTo(0.0, 0.0).lineTo(0.0, 100.0).lineTo(105.0, 100.0).lineTo(58.0, 25.0).threePointArc((42.0, 8.0), (30.0, 0.0)).close().extrude(3.0)
